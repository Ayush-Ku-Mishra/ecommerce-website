...
const CheckoutPage = () => {
  ...
  return (
    <div>
      ...
      <div className="w-full sticky top-32 z-50 self-start bg-[#f9f9f9]">
        <HorizontalLinearAlternativeLabelStepper activeStep={activeStepIndex} />
      </div>

      <div className="flex min-w-[1200px] gap-8">
          ...
          <div className="border-2 p-4 shadow-sm shadow-blue-400">
            ...
            {step === "summary" ? (
              cart.length === 0 ? (
                ...
                <ul className="divide-y border rounded-xl overflow-hidden max-h-auto">
        ...
        <div className="max-w-[300px] h-[340px] sticky top-52 self-start w-[35%] bg-white rounded-lg shadow-md p-6 border border-gray-200 md:w-1/3">
