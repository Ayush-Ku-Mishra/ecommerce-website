  ...
  return (
    <div className='border'>
      ...
      <div className=''>
        ...
        <SwiperSlide>
            <Link to="/fashion" className='flex flex-col items-center justify-center'>
        ...
        <SwiperSlide>
            <Link to="/electronics" className='flex flex-col items-center justify-center '>
        ...
        <SwiperSlide>
            <Link to="/bags" className='flex flex-col items-center justify-center '>
        ...
        <SwiperSlide>
            <Link to="/footwear" className='flex flex-col items-center justify-center '>
        ...
        <SwiperSlide>
            <Link to="/groceries" className='flex flex-col items-center justify-center '>
        ...
        <SwiperSlide>
            <Link to="/beauty" className='flex flex-col items-center justify-center '>
        ...
        <SwiperSlide>
            <Link to="/furnitures" className='flex flex-col items-center justify-center '>
        ...
        <SwiperSlide>
            <Link to="/jewellery" className='flex flex-col items-center justify-center '>
