...
const SingleProductDetails = () => {
  ...
  const [selectedAddress, setSelectedAddress] = useState("123 Main Street, Bhubaneswar");
  ...
  return (
    <div>
      ...
      <div className="mt-3 overflow-y-auto pr-4 scrollbar-hide">
        <p className="text-[#878787] text-[16px] font-[500]">{product.brand}</p>
        ...
        <div className="flex items-center gap-1 mb-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#878787] text-md font-[500]">Ratings &</span>
          </div>
        ...
        >
          <div className="flex items-center justify-between mb-3">
            ...
            <p className="text-[25px] font-semibold">{showDetails ? "−" : "+"}</p>
          </div>
